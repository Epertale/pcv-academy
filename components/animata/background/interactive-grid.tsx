...
const size = 24; // h-6
const boxClassName =
  "absolute h-6 w-6 rounded-md bg-transparent p-px border border-gray-400/50 border-box group ";
...
export default function InteractiveGrid({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(123deg, transparent 0%, transparent 0%,rgba(0, 0, 0, 0) 0%, rgba(17, 17, 87, 0) 0%,transparent 0%, transparent 0%),linear-gradient(251deg, transparent 0%, transparent 68%,rgba(3, 3, 3,0.02) 0%, rgba(3, 3, 93,0.02) 0%,transparent 0%, transparent 0%),linear-gradient(135deg, rgb(255, 255, 255),rgb(255, 255, 255))",
      }}
    >
      <Grid />
