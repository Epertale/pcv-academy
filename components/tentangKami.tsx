...
export default function TentangKamiSection() {
  const team = [
    {
      name: "Ravendo Zacariva A.",
      role: "Project Manager (PM)",
      img: "/anggota/ravendo.png",
    },
    {
      name: "Fransiskus K.H.",
      role: "Web Developer",
      img: "/anggota/frans.png",
    },
    {
      name: "Brain Overino",
      role: "Business Consultant",
      img: "/anggota/brain.png",
    },
    {
      name: "Ricky Avriel I.",
      role: "UI/UX Designer",
      img: "/anggota/ricky.png",
    },
    {
      name: "Reyhan Bayu Desfrianto",
      role: "Content Strategist",
      img: "/anggota/reyhan.png",
    },
    {
      name: "Taruna Adi Wibowo",
      role: "Digital Marketing Specialist",
      img: "/anggota/taruna.png",
    },
  ];
  ...
  return (
    <section className="text-white py-12 max-w-6xl mx-auto">
      ...
      <div className="border-b-2 border-white w-24 mx-auto mb-10" />
